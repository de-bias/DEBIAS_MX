...
Outputs <- "../../results/explain_bias/holdout/Final_Results_HoldOut_GS5184_P05_Knn"
# Value the training set from 0 to 1
train_proportion <- 0.7
# Paths
Path01 <- "../../data/processed/explain_bias/holdout/Census_data.csv"
Path02 <- "../../data/processed/explain_bias/holdout/SHP/MunicipalitiesMX.shp"
Path03 <- "../../data/processed/explain_bias/holdout/Active_population_bias_knn_p0005.csv"
Path04 <- "../../data/processed/explain_bias/holdout/Labels.csv" 
Path05 <- "../../data/processed/explain_bias/holdout/SHP/StatesMX.shp"
