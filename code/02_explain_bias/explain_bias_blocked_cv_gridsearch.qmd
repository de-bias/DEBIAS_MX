...
Outputs <- "../../results/explain_bias/blocked_cv/Final_Results_BlockedCV_GS5184_P05_Knn"
# Value the training set from 0 to 1
# train_proportion <- 0.7
VFolds <- 5
# Paths
Path01 <- "../../data/processed/explain_bias/blocked_cv/Census_data.csv"
Path02 <- "../../data/processed/explain_bias/blocked_cv/SHP/MunicipalitiesMX.shp"
Path03 <- "../../data/processed/explain_bias/blocked_cv/Active_population_bias_knn_p0005.csv"
Path04 <- "../../data/processed/explain_bias/blocked_cv/Labels.csv" # TTS
Path05 <- "../../data/processed/explain_bias/blocked_cv/SHP/StatesMX.shp"
