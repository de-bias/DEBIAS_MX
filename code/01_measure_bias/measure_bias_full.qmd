...
Outputs <- "../../results/measure_bias/phone_00_05"
...
```{r}
Population_data <- read.csv("../../data/raw/census/census2020_municipal_population.csv", fileEncoding = "latin1") 
...
```{r}
Geographical_areas <- st_read("../../data/raw/spatial/municipalities_measure_bias/MunicipiosMX.shp")
...
```{r}
Active_population <- read.csv("../../data/raw/active_population/phone_00_05.csv", fileEncoding = "latin1") 
